        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="text-center">Hapus data yang telah dipilih ?</p>
                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <button id="closeModal" class="btn btn-light border-primary px-4"
                        data-bs-dismiss="modal">Batal</button>
                    <button wire:click="destroy" class="btn btn-light border-primary px-4" style="width: 100px;">
                        <span wire:loading.remove wire:target="destroy">Hapus</span>
                        <span wire:loading wire:target="destroy" class="spinner-border spinner-border-sm text-primary"
