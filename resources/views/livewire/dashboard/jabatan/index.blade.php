        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @if ($showLivewireCreate)
                    @livewire('dashboard.jabatan.create')
                    <script>
                ...
                @if ($showLivewireUpdate)
                    @livewire('dashboard.jabatan.update', ['jabatan' => $getJabatan])
                    <script>
                        $(document).ready(function() {
                ...
                @if ($showLivewireDelete)
                    @livewire('dashboard.jabatan.delete', ['jabatan' => $getJabatan])
                    <script>
                        $(document).ready(function() {
                ...
                <div class="card pt-2">
                                    ...
                                    <thead class="text-light">
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;text-align: center;text-align: center;">ID
                                                Jabatan</th>
                                            <th style="vertical-align: middle;text-align: left;">Nama Jabatan</th>
                                                ...
                                                <td style="vertical-align: middle;text-align: center;">
                                                    ...
                                                    <button style="width: 40px;"
                                                        ...
                                                        <span wire:loading.remove
                                                            wire:target="edit({{ $data->id_jabatan }})"><i
                                                    ...
                                                    <button style="width: 40px;"
                                                        ...
                                                        <span wire:loading.remove
                                                            wire:target="delete({{ $data->id_jabatan }})"><i
                    ...
                    <div class="d-flex justify-content-end">{{ $jabatan->links() }}</div>
                @else
                    <hr>
