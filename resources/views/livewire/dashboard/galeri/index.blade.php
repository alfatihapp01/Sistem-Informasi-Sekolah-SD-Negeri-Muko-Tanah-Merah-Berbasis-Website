        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @if ($showLivewireCreate)
                    @livewire('dashboard.galeri.create')
                    <script>
                ...
                @if ($showLivewireUpdate)
                    @livewire('dashboard.galeri.update', ['galeri' => $getGaleri])
                    <script>
                        $(document).ready(function() {
                ...
                @if ($showLivewireDelete)
                    @livewire('dashboard.galeri.delete', ['galeri' => $getGaleri])
                    <script>
                        $(document).ready(function() {
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">Judul Image</th>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align: center;">
                                                    <button style="width: 40px;"
                                                        ...
                                                        wire:click="edit({{ $data->id_galeri }})"
                                                        ata-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Ubah">
                                                        <span wire:loading.remove
                                                            wire:target="edit({{ $data->id_galeri }})"><i
                                                                class="bi bi-pencil-square"></i></span>
                                                        <span wire:loading wire:target="edit({{ $data->id_galeri }})"
                                                    ...
                                                    <button style="width: 40px;"
                                                        ...
                                                        wire:click="delete({{ $data->id_galeri }})"
                                                        ata-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Hapus">

                                                        <span wire:loading.remove
                                                            wire:target="delete({{ $data->id_galeri }})"><i
                                                                class="bi bi-trash"></i></span>
                                                        <span wire:loading
                                                            wire:target="delete({{ $data->id_galeri }})"
                                                            class="spinner-border spinner-border-sm text-light"
                                                            role="status" aria-hidden="true"
                                                            style="width: 11px; height: 11px;"></span>
                                                    </button>
