<nav class="main-header navbar navbar-expand border-0 navbar-danger" style="background-color: ;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="/" class="nav-link text-light"><i class="bi bi-house-fill"></i> Beranda</a>
        </li>
    </ul>
